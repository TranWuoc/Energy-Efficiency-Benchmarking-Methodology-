        ...
        <div className=" flex flex-col gap-[30px]">
            <div className="flex w-[950px] items-center justify-between gap-4">
                <div className="flex flex-col ">
                    <span className="font-bold"> a. Khu làm việc hành chính</span>
            ...
            <div className="flex w-[950px]  justify-between gap-4">
                <div className="flex flex-col ">
                    ...
                    <div className="flex w-[450px] items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <InputField name="CameraOpen" component={DropdownPickerTime} />
                            <span>Đến</span>
                            <InputField name="CameraClose" component={DropdownPickerTime} />
                        </div>
                    </div>
                </div>
            </div>
